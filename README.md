...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,438 | 🐛 74 | 📅 2026-02-25.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,358 | 🐛 133 | 🌐 PHP | 📅 2026-03-23
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,358 | 🐛 133 | 🌐 PHP | 📅 2026-03-23
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,358 | 🐛 133 | 🌐 PHP | 📅 2026-03-23
...
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,226 | 🐛 21 | 🌐 PHP | 📅 2025-11-16 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,024 | 🐛 39 | 🌐 PHP | 📅 2026-03-23 installation and configuration management for Symfony packages.
...
* [Composer-Dependency-Analyzer](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 604 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 - The plugin helps to find dependency issues, including dead, unused, shadow and misplaced dependencies.
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 595 | 🐛 14 | 🌐 PHP | 📅 2026-03-20 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,787 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 coding standards (rulesets).
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 4 | 🌐 PHP | 📅 2026-03-18 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 990 | 🐛 43 | 🌐 PHP | 📅 2026-03-23 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
...
* [Composer-Substitution-Plugin](https://github.com/villfa/composer-substitution-plugin) ⭐ 51 | 🐛 2 | 🌐 PHP | 📅 2024-01-31 - A Composer plugin replacing placeholders in the `scripts` section by dynamic values.
