...
You might also like [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,567 | 🐛 70 | 📅 2026-06-10.
...
* [GitHub](https://github.com/composer/composer) ⭐ 29,457 | 🐛 145 | 🌐 PHP | 📅 2026-06-12
* [Issues](https://github.com/composer/composer/issues) ⭐ 29,457 | 🐛 145 | 🌐 PHP | 📅 2026-06-12
* [Source](https://github.com/composer/composer/tree/HEAD/src/Composer) ⭐ 29,457 | 🐛 145 | 🌐 PHP | 📅 2026-06-12
* [Composer Installers](https://github.com/composer/installers) ⭐ 1,436 | 🐛 25 | 🌐 PHP | 📅 2026-05-28 - Composer installers for multiple frameworks.
...
* [Prestissimo](https://github.com/hirak/prestissimo) ⭐ 6,125 | 🐛 40 | 🌐 PHP | 📅 2022-12-03 - A parallel downloader using `phpext_curl`.
* [Symfony-Flex](https://github.com/symfony/flex) ⭐ 4,223 | 🐛 13 | 🌐 PHP | 📅 2026-05-29 - Provides [recipe-based](https://github.com/symfony/recipes) ⭐ 1,026 | 🐛 36 | 🌐 PHP | 📅 2026-06-03 installation and configuration management for Symfony packages.
* [PackageVersions](https://github.com/Ocramius/PackageVersions) ⭐ 3,179 | 🐛 3 | 🌐 PHP | 📅 2026-06-05 - Provides a very quick and easy access to installed composer dependency versions.
* [Composer-Patches](https://github.com/cweagans/composer-patches) ⭐ 1,707 | 🐛 52 | 🌐 PHP | 📅 2026-06-11 - The plugin applies a patch from a local or remote file to any required package.
...
* [Composer-Dependency-Analyzer](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 618 | 🐛 20 | 🌐 PHP | 📅 2026-05-28 - The plugin helps to find dependency issues, including dead, unused, shadow and misplaced dependencies.
* [PHPCodeSniffer-Composer-Installer](https://github.com/PHPCSStandards/composer-installer) ⭐ 598 | 🐛 10 | 🌐 PHP | 📅 2026-06-05 - The plugin enables you to install [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,773 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 coding standards (rulesets).
...
* [Composer-Bin-Plugin](https://github.com/bamarni/composer-bin-plugin) ⭐ 528 | 🐛 7 | 🌐 PHP | 📅 2026-02-04 - Adds support for managing dependencies for multiple packages in a single repository or isolate bin dependencies.
...
* [Composer-Patches](https://github.com/vaimo/composer-patches) ⭐ 301 | 🐛 31 | 🌐 PHP | 📅 2026-06-12 - Applies a patch from a local or remote file to any package that is part of a given composer project.
* [Composer-Versions-Check](https://github.com/Soullivaneuh/composer-versions-check) ⭐ 235 | 🐛 17 | 🌐 PHP | 📅 2021-12-02 - Shows outdated packages from last major versions after using the update command (showing "Latest is vX.Y.Z").
...
* [Composer-Diff](https://github.com/IonBazan/composer-diff) ⭐ 187 | 🐛 4 | 🌐 PHP | 📅 2026-03-19 - Compares `composer.lock` changes and generates a Markdown report for usage in a pull request description.
...
* [Imposter-Plugin](https://github.com/typisttech/imposter-plugin) ⭐ 157 | 🐛 8 | 🌐 PHP | 📅 2026-06-04 - Wrapping all composer vendor packages inside your own namespace. Intended for WordPress plugins.
...
* [Composer-Patches-Plugin](https://github.com/netresearch/composer-patches-plugin) ⭐ 80 | 🐛 1 | 🌐 PHP | 📅 2026-06-08 - Enables you to provide patches for any package from any package. When the dependency is fetched, the patch is applied on top.
...
* [Composer-Plugin-Exclude-Files](https://github.com/mcaskill/composer-plugin-exclude-files) ⭐ 40 | 🐛 0 | 🌐 PHP | 📅 2026-06-11 - A plugin for excluding files required by packages using the 'files' autoloading mechanism.
...
* [Drupal Vendor Hardening Composer Plugin](https://github.com/drupal/core-vendor-hardening) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2026-06-11 - Removes extraneous directories from the project's vendor directory & adds .htaccess and web.config files to the root of the project's vendor directory.
...
* [Composer Translation Validator](https://github.com/move-elevator/composer-translation-validator) ⭐ 3 | 🐛 3 | 🌐 PHP | 📅 2026-06-14 - Validates translation files in your project, supports several file formats (regarding different frameworks) and provides useful validators for comparison, consistency and syntax checks.
...
* [OctoLinker Browser Extension](https://github.com/OctoLinker/OctoLinker) ⭐ 5,366 | 🐛 62 | 🌐 HTML | 📅 2023-10-02 - Enables you to navigate Composer/NPM dependencies on GitHub.
* [Composer/Xdebug-Handler](https://github.com/composer/xdebug-handler) ⭐ 2,562 | 🐛 0 | 🌐 PHP | 📅 2026-05-29 - Helps you to restart a CLI process without loading the xdebug extension.
...
* [Composer-Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,111 | 🐛 11 | 🌐 PHP | 📅 2026-06-07 - The plugin helps to keep your `composer.json` file(s) consistent by restructuring and sorting entries (normalizing).
* [ComposerRequireChecker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,002 | 🐛 45 | 🌐 PHP | 📅 2026-06-05 - A CLI tool to analyze dependencies and verify that no unknown imported symbols are used in the sources of a package.
...
* [Private Packagist API Client](https://github.com/packagist/private-packagist-api-client) ⭐ 35 | 🐛 1 | 🌐 PHP | 📅 2026-06-04 - A PHP client for the Private Packagist API. The client handles authentication, signature generation and access to all endpoints.
...
* [Packeton](https://github.com/vtsykun/packeton) ⭐ 530 | 🐛 50 | 🌐 PHP | 📅 2026-04-29 - Private self-hosted Composer repository for vendors. Fork of packagist with adding support for authorization, customer users, groups, webhooks.
...
* [Satisfy](https://github.com/project-satisfy/satisfy) ⭐ 547 | 🐛 8 | 🌐 PHP | 📅 2025-05-28 - Satis composer repository manager with a Web UI.
